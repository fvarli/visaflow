...
export function PreviousVisasStep() {
  ...
  return (
    <CollectionEditor<PreviousVisa>
      ...
      validate={(d) => d.country.length === 2 && d.visaType.trim().length > 0}
      emptyIcon={Stamp}
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <Field label={t('applicant:fields.visaIssueDate')}>
            <Input
              ...
              onChange={(e) =>
                setDraft({ ...draft, issueDate: e.target.value || undefined })
              }
            />
          </Field>
          ...
          <Field label={t('applicant:fields.visaExpiryDate')}>
            <Input
              ...
              onChange={(e) =>
                setDraft({ ...draft, expiryDate: e.target.value || undefined })
              }
            />
          </Field>
          ...
          <Field label={t('applicant:fields.visaStatus')} htmlFor="visa-status">
            <Select
          ...
          <Field label={t('applicant:fields.notes')} className="sm:col-span-2">
            <Textarea
              rows={2}
              value={draft.notes ?? ''}
              onChange={(e) =>
